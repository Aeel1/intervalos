...
export function FormA() {
  ...
  const qua = ['null', 'null','null', 'Db', 'D', 'D#'];
  const qui = ['null', 'null','null', 'null', 'null', 'Eb', 'E', 'E#'];
  const sex = ['null', 'null','null', 'null', 'null','null', 'null', 'F', 'F#'];
  const set = ['null', 'null','null', 'null', 'null','null', 'null','null','Gb', 'G', 'G#'];
  const oit = ['null', 'null','null', 'null', 'null','null', 'null','null','null','null','null','A'];
