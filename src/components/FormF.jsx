...
export function FormF() {
  ...
  const seg = ['Gb', 'G', 'G#'];
  const ter = ['null', 'null', 'Ab', 'A'];
  const qua = ['null', 'null','null', 'Bbb', 'Bb', 'B'];
  const qui = ['null', 'null','null', 'null', 'null', 'Cb', 'C', 'C#'];
  const sex = ['null', 'null','null', 'null', 'null','null', 'null', 'Db', 'D'];
  const set = ['null', 'null','null', 'null', 'null','null', 'null','null','Ebb', 'Eb', 'E'];
