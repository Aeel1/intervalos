...
export function FormAbemol() {
  ...
  const seg = ['Bbb', 'Bb', 'B'];
  const ter = ['null', 'null', 'Cb', 'C'];
  const qua = ['null', 'null','null', 'Dbb', 'Db', 'D'];
  const qui = ['null', 'null','null', 'null', 'null', 'Ebb', 'Eb', 'E'];
  const sex = ['null', 'null','null', 'null', 'null','null', 'null', 'Fb', 'F'];
  const set = ['null', 'null','null', 'null', 'null','null', 'null','null','Gbb', 'Gb', 'G'];
  const oit = ['null', 'null','null', 'null', 'null','null', 'null','null','null','null','null','Ab'];
