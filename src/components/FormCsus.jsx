...
export function FormCsus() {
  ...
  const seg = ['D', 'D#', 'D##'];
  const ter = ['null', 'null', 'E', 'E#'];
  const qua = ['null', 'null','null', 'F', 'F#', 'F##'];
  const qui = ['null', 'null','null', 'null', 'null', 'G', 'G#', 'G##'];
  const sex = ['null', 'null','null', 'null', 'null','null', 'null', 'A', 'A#'];
