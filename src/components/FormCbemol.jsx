...
export function FormCbemol() {
  ...
  const seg = ['Dbb', 'Db', 'D'];
  const ter = ['null', 'null', 'Ebb', 'Eb'];
  const qua = ['null', 'null','null', 'Fbb', 'Fb', 'F'];
  const qui = ['null', 'null','null', 'null', 'null', 'Gbb', 'Gb', 'G'];
  const sex = ['null', 'null','null', 'null', 'null','null', 'null', 'Abb', 'Ab'];
  const set = ['null', 'null','null', 'null', 'null','null', 'null','null','Bbbb', 'Bbb', 'Bb'];
  const oit = ['null', 'null','null', 'null', 'null','null', 'null','null','null','null','null','Cb'];
