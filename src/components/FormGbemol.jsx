...
export function FormGbemol() {
  ...
  const seg = ['Abb', 'Ab', 'A'];
  const ter = ['null', 'null', 'Bbb', 'Bb'];
  const qua = ['null', 'null','null', 'Cbb', 'Cb', 'C'];
  const qui = ['null', 'null','null', 'null', 'null', 'Dbb', 'Db', 'D'];
  const sex = ['null', 'null','null', 'null', 'null','null', 'null', 'Ebb', 'Eb'];
  const set = ['null', 'null','null', 'null', 'null','null', 'null','null','Fbb', 'Fb', 'F'];
  const oit = ['null', 'null','null', 'null', 'null','null', 'null','null','null','null','null','Gb'];
