...
export function FormB() {
  ...
  const seg = ['C', 'C#', 'C##'];
  const ter = ['null', 'null', 'D', 'D#'];
  const qua = ['null', 'null','null', 'Eb', 'E', 'E#'];
  const qui = ['null', 'null','null', 'null', 'null', 'F', 'F#', 'F##'];
  const sex = ['null', 'null','null', 'null', 'null','null', 'null', 'G', 'G#'];
  const set = ['null', 'null','null', 'null', 'null','null', 'null','null','Ab', 'A', 'A#'];
  const oit = ['null', 'null','null', 'null', 'null','null', 'null','null','null','null','null','B'];
