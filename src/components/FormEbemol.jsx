...
export function FormEbemol() {
  ...
  const seg = ['Fb', 'F', 'F#'];
  const ter = ['null', 'null', 'Gb', 'G'];
  const qua = ['null', 'null','null', 'Abb', 'Ab', 'A'];
  const qui = ['null', 'null','null', 'null', 'null', 'Bbb', 'Bb', 'B'];
  const sex = ['null', 'null','null', 'null', 'null','null', 'null', 'Cb', 'C'];
  const set = ['null', 'null','null', 'null', 'null','null', 'null','null','Dbb', 'Db', 'D'];
  const oit = ['null', 'null','null', 'null', 'null','null', 'null','null','null','null','null','Eb'];
