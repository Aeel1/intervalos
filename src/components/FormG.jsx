...
export function FormG() {
  ...
  const seg = ['Ab', 'A', 'A#'];
  const ter = ['null', 'null', 'Bb', 'B'];
  const qua = ['null', 'null','null', 'Cb', 'C', 'C#'];
  const qui = ['null', 'null','null', 'null', 'null', 'Db', 'D', 'D#'];
  const sex = ['null', 'null','null', 'null', 'null','null', 'null', 'Eb', 'E'];
  const set = ['null', 'null','null', 'null', 'null','null', 'null','null','Fb', 'F', 'F#'];
  const oit = ['null', 'null','null', 'null', 'null','null', 'null','null','null','null','null','G'];
