...
export function FormDbemol() {
  ...
  const seg = ['Ebb', 'Eb', 'E'];
  const ter = ['null', 'null', 'Fb', 'Fb'];
  const qua = ['null', 'null','null', 'Gbb', 'Gb', 'Gb'];
  const qui = ['null', 'null','null', 'null', 'null', 'Abb', 'Ab', 'A'];
  const sex = ['null', 'null','null', 'null', 'null','null', 'null', 'Bb', 'B'];
  const set = ['null', 'null','null', 'null', 'null','null', 'null','null','Cbb', 'Cb', 'C'];
  const oit = ['null', 'null','null', 'null', 'null','null', 'null','null','null','null','null','Db'];
