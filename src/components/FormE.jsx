...
export function FormE() {
  ...
  const seg = ['F', 'F#', 'F##'];
  const ter = ['null', 'null', 'G', 'G#'];
  const qua = ['null', 'null','null', 'Ab', 'A', 'A#'];
  const qui = ['null', 'null','null', 'null', 'null', 'Bb', 'B', 'B#'];
  const sex = ['null', 'null','null', 'null', 'null','null', 'null', 'C', 'C#'];
  const set = ['null', 'null','null', 'null', 'null','null', 'null','null','Db', 'D', 'D#'];
  const oit = ['null', 'null','null', 'null', 'null','null', 'null','null','null','null','null','E'];
