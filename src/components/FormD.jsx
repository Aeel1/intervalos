...
export function FormD() {
  ...
  const seg = ['Eb', 'E', 'E#'];
  const ter = ['null', 'null', 'F', 'F#'];
  const qua = ['null', 'null','null', 'Gb', 'G', 'G#'];
  const qui = ['null', 'null','null', 'null', 'null', 'Ab', 'A', 'A#'];
  const sex = ['null', 'null','null', 'null', 'null','null', 'null', 'Bb', 'B'];
  const set = ['null', 'null','null', 'null', 'null','null', 'null','null','Cb', 'C', 'C#'];
  const oit = ['null', 'null','null', 'null', 'null','null', 'null','null','null','null','null','D'];
