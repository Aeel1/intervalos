...
export function FormFsus() {
  ...
  const seg = ['G', 'G#', 'G##'];
  const ter = ['null', 'null', 'A', 'A#'];
  const qua = ['null', 'null','null', 'Bb', 'B', 'B#'];
  const qui = ['null', 'null','null', 'null', 'null', 'C', 'C#', 'C##'];
  const sex = ['null', 'null','null', 'null', 'null','null', 'null', 'D', 'D#'];
  const set = ['null', 'null','null', 'null', 'null','null', 'null','null','Eb', 'E', 'E#'];
  const oit = ['null', 'null','null', 'null', 'null','null', 'null','null','null','null','null','F#'];
